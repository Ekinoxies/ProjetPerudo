 ...
 * @author Quizz
 */
public class JoueurJouer extends javax.swing.JFrame {
...
public InterfaceServeur connectServer() {
try
	{
	Registry reg= LocateRegistry.getRegistry("localhost",1099);
	InterfaceServeur proxy= (InterfaceServeur) reg.lookup("MonServeur");
     ...
     */
    public JoueurJouer(Joueurs j,String nomP) {
...
// TODO add your handling code here:
    ...
    private void BoutonMenteurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BoutonMenteurActionPerformed
        ...
        InterfaceServeur proxy = null;
        try {
            proxy = (InterfaceServeur) Naming.lookup("rmi://localhost:1099/MonServeur");
        } catch (NotBoundException ex) {
            Logger.getLogger(JoueurConnexion.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void BoutonPileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BoutonPileActionPerformed
        ...
        try {
            ...
            Logger.getLogger(JoueurJouer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(Joueurs j, String nomP) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JoueurJouer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JoueurJouer(j,nomP).setVisible(true);
            }
        });
    }
