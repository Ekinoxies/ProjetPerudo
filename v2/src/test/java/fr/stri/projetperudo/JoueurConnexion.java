 ...
 * @author Quizz
 */
public class JoueurConnexion extends javax.swing.JFrame {

    /**
     * Creates new form ConnexionJoueur
     */
    public JoueurConnexion() {
        initComponents();
    }
    ...
    {
        try {           
            InterfaceServeur proxy = (InterfaceServeur) Naming.lookup("rmi://localhost:1099/MonServeur");
    ...
    String retour;
     ...
     InterfaceServeur proxy = null;
        ...
        try {
            ...
            JoueurJouer.main(envoijoueur, resultNomPartie);
   ...
   InterfaceServeur proxy = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JoueurConnexion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JoueurConnexion().setVisible(true);
                ProxyRMI();               
